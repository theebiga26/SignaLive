  ...
  return (
    <section id="faq" className="w-full min-h-[100svh] pt-24 md:pt-28 lg:pt-28 pb-12 flex flex-col items-center justify-start relative overflow-hidden bg-[#0c132c]">
      ...
      <div className="max-w-[1400px] w-full z-10 mx-auto flex flex-col pointer-events-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 w-full mt-4">
          
          {/* Left Column: Scrollable Accordion */}
          <div className="lg:col-span-2 flex flex-col gap-4 max-h-[700px] overflow-y-auto pr-2 md:pr-4 scrollbar-thin scrollbar-thumb-orange-500/50 scrollbar-track-white/5 hover:scrollbar-thumb-orange-500">
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  <div className="p-5 md:px-6 md:py-4 flex justify-between items-center">
                    <h3 className={`text-base md:text-lg font-bold pr-8 ${isOpen ? 'text-white' : 'text-gray-200'}`}>
                      {faq.question}
                    </h3>
          ...
          <div className="flex flex-col justify-center gap-4 h-full">
            ...
            <div className="bg-[#050914] rounded-[2rem] border border-white/5 overflow-hidden flex flex-col items-center text-center relative shadow-2xl">
               <div className="p-6 pb-12 flex flex-col items-center z-10">
            ...
            {/* Availability Card */}
            <div className="bg-[#0f172a] rounded-[2rem] border border-white/5 p-6 flex items-center gap-4 shadow-xl">
